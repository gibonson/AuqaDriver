    ...
    def __init__(self, sched):
        with app.app_context():
            ...
            for device in devices:
                scheduler_id = "DeviceChecker: " + device.deviceIP + " - " + device.deviceName
                if device.deviceStatus == "Ready":
                    add_job_to_scheduler(sched,"job_collector",scheduler_id, "http://" + device.deviceIP + "/status","interval",0,0,0,1,0)
