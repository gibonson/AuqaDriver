    ...
    def __init__(self):
        ...
        try:
            ...
            for scheduler_data in scheduler_list:
                ...
                self.eventsScheduler.append(scheduler)
        except Exception as e:
            logger.error(f"An error occurred while fetching EventScheduler: {e}")

    def get_all(self):
        return self.eventsScheduler

    def get_by_name(self, schedulerName):
        for eventScheduler in self.eventsScheduler:
            if eventScheduler.schedulerName == schedulerName:
